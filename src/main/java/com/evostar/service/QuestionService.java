...
public class QuestionService {
    ...
    public List<Question> getLatestFollowedQuestions(List<String> userList, int offset, int limit) {
        return questionDAO.selectLatestFollowedQuestions(userList, offset, limit);
    }
